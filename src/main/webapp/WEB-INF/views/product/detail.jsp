...
<c:if test="${loginMember.id eq 'admin'}">
    <input type="button" value="제품 수정"
           onclick="location.href='${contextPath}/product/changeProductPage?proNo=${detail.proNo}'"/>
    <input type="button" value="옵션 추가"
           onclick="location.href='${contextPath}/product/saveProductOption?proNo=${detail.proNo}'"/>
    <input type="button" value="옵션 수정"
           onclick="location.href='${contextPath}/product/changeProductOptionPage?proNo=${detail.proNo}'"/>
    <input type="button" value="제품 삭제"
           onclick="location.href='${contextPath}/product/productDelete?proNo=${detail.proNo}'"/>
</c:if>
...
<div class="container" style="width: 70%; margin-bottom:100px;">
    ...
    <div>
        <img src="${contextPath}/product/display?proimgNo=${detail.productImageDTO.proimgNo}" width="300px"
             height="300px" id="big_img">
        <img src="${contextPath}/product/display?proimgNo=${detail.productImageDTO.proimgNo}" width="40px" height="30px"
             class="thumbnail">
    </div>

    <div class="row productInfo"
         style="width: 40%; float: right; margin-bottom: 30px; margin-left: 150px; padding-left: 150px;">
                ...
                <table border="1" style="text-align: center;">
                    ...
                    <c:forEach items="${reviews}" var="re" varStatus="vs">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="${contextPath}/product/detailReview?reviewNo=${re.reviewNo}"
                                   rel="modal:open">${re.reviewContent}</a>
                            </td>
                            <td>
                                <c:forEach var="reviewStar" items="${ ratingOptions }" varStatus="vs" begin="1"
                                           end="${ re.reviewStar }"><img
                                        src="https://d29fhpw069ctt2.cloudfront.net/icon/image/84580/preview.svg"
                                        style="width:30px"></c:forEach>
                            </td>
                            <td>
