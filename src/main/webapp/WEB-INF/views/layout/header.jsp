  ...
  <nav class="py-2 bg-light border-bottom">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="${contextPath}/admin/member/list" class="nav-link link-dark px-2">관리자 페이지</a></li>
      	</c:if>
      </ul>
      <ul class="nav">
       <c:if test="${loginMember eq null}">
        <li class="nav-item"><a href="${contextPath}/member/loginPage" class="nav-link link-dark px-2">로그인</a></li>
  ...
  <header class="py-3 mb-4 border-bottom">
    <div class="container d-flex flex-wrap justify-content-center">
      ...
      <form id="f" class="col-12 col-lg-auto mb-3 mb-lg-0" method="get" action="${contextPath}/product/find">
        <input type="hidden" name="column" id="column" value="PRO_NAME">
        <input type="search" class="form-control" name="query" id="query" placeholder="Search..." aria-label="Search">
      </form>
    </div>
  </header>
